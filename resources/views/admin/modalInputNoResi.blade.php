<div class="modal fade" id="inputResiPos" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                ...
                <form action="{{ route('inputNomorResi') }}" method="POST" id="form-upload" enctype="multipart/form-data">
                    ...
                    <table width="100%" class="table ">
                        ...
                        <tr style="background-color: rgb(145, 207, 104); ">
                            <td class="text-white">Input Nomor Resi POS</td>  
                        </tr>
                        
                        <tr>
                            <input type="hidden" name="id_permohonan" value="{{ $permohonan->id_permohonan }}">
                             <td>
                                <input type="text" name="no_resi" class="form-control" placeholder="Input Nomor Resi POS" autofocus required>
